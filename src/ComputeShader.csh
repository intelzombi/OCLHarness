...
//--------------------------------------------------------------------------------------
// CellularAutomataComputeShader (CACS)
// main entry point
//--------------------------------------------------------------------------------------

// run each thread group with dimensions THREADS_X x THREADS_Y
[numthreads(THREADS_X,THREADS_Y,1)]
void CellularAutomataHS( uint3 get_group_id : SV_GroupID, 
						 uint3 get_global_id : SV_DispatchThreadID, 
						 uint3 get_local_id : SV_GroupThreadID, 
